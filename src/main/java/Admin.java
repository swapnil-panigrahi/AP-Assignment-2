public class Admin implements Person{
    ...
    public void addAttraction(String name, Integer id, Integer price) {
        Attraction attraction = new Attraction(name, id, price);
                ...
                try {
                    ...
                    switch (choice) {
                        ...
                        case 2:
                            ...
                            Integer price = Integer.parseInt(System.console().readLine());
    ...
    public void scheduleEvent(Integer id){
        for (Attraction attraction : this.zoo.getAttractions()){
            if (attraction.getId().equals(id)){
                ...
                try {
                    ...
                    switch (choice) {
                        ...
                        case 2:
                            ...
                            String sound = System.console().readLine();
    ...
    public void viewVisitorStats(){
        ...
        for (Visitor visitor : this.zoo.getVisitors()){
            if (visitor.getAnimals() != null || visitor.getAttractions() != null){
                total_visitor++;
            }
        }
